...
class nick(genericcommand.genericcommand):
    ...
    def handle(self, origin, args):
        ...
        if origin[1] == None:
            ...
            self._state.newUser((origin[0], p10.base64.toInt(args[-2])), args[0], args[3], args[4], modes, p10.base64.toInt(args[-3]), args[1], args[2], args[-1])
        else:
            self._state.changeNick(origin, args[0])