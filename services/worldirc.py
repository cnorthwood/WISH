...
class worldirc:
    ...
    def __init__(self, state):
        ...
        self._state.createChannel((self._state.getServerID(), 1), "#help", self._state.ts())
        self._state.createChannel((self._state.getServerID(), 1), "#opers", self._state.ts())
    
    def callbackChannelCreate(self, (origin, name, ts)):
        self._state.privmsg((self._state.getServerID(), 1), "#opers", "Hello, I am the test bot for the next-generation WorldIRC services. I just got channel creation info about " + name)
